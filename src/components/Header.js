			...
			<div className="flex flex-wrap items-center justify-between mx-auto p-4">
				...
				<div id="nav-links" className={`items-center justify-between ${hidden ? "hidden" : ""} w-full md:flex md:w-auto md:order-1`}>
					<div className="relative mt-3 md:hidden">
						...
						<form onSubmit={ handleSubmit }>
						<input type="text" id="search" name='search' className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete='off' />
						</form>
					</div>
					<ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
						...
						<li>
						<NavLink to="/movie/top_rated" className={ ({isActive}) => isActive ? activeClass : inActiveClass }>Top Rated</NavLink>
						</li>
						<li>
